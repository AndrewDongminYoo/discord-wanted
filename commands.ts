  ...
  options: [
    {
      ...
      choices: [
        ...
        { name: 'gyeonggi', value: '경기' },
        { name: 'gangwon', value: '강원' },
        { name: 'n-chungcheong', value: '충북' },
        { name: 's-chungcheong', value: '충남' },
        { name: 'n-jeolla', value: '전북' },
        { name: 's-jeolla', value: '전남' },
        { name: 'n-gyeongsang', value: '경북' },
        { name: 's-gyeongsang', value: '경남' },
        { name: 'jeju', value: '제주' },
      ],
    },
    {
